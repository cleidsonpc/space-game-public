...
compilation. You can either let the plugin generate an HTML file for you, supply
...
* [inject-body-webpack-plugin](https://github.com/Jaid/inject-body-webpack-plugin) is a simple method of injecting a
  custom HTML string into the body.
...
- `htmlWebpackPlugin`: data specific to this plugin
    ...
    - `htmlWebpackPlugin.tags`: the prepared `headTags` and `bodyTags` Array to render
      the `<base>`, `<meta>`, `<script>` and `<link>` tags.
