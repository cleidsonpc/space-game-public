...
* **What about duplicate or falsey elements?**
  ...
  The `createJoinImplementation` will eliminate any invalid elements regardless of whether you use `Array`
  or `Iterator`. This makes it possible to `&&` elements inline with a predicate value.
